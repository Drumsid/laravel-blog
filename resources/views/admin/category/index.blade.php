    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
          <a class="btn btn-primary float-right" href="{{ route('category.create') }}" role="button">Добавить категорию</a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                ...
                <table id="category-table" class="table table-bordered table-hover">
                  ...
                  @forelse ($categories as $key => $category)
                    <tr>
                      ...
                      <td>
                          <a href="{{ route('category.edit', $category) }}" class="btn btn-info btn-sm float-left mr-1">
