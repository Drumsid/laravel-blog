    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
          <a class="btn btn-primary float-right" href="{{ route('song.create') }}" role="button">Добавить песню</a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                  ...
                  @forelse ($songs as $key => $song)
                    <tr>
                      ...
                      <td style="white-space: nowrap; width: 110px">
                          <a href="{{ route('song.edit', $song) }}" class="btn btn-info btn-sm float-left mr-1">
                              <i class="fas fa-pencil-alt"></i>
                          </a>
                          <a href="{{ route('song.show', $song) }}" class="btn btn-info btn-sm float-left mr-1">
                          <i class="fas fa-eye"></i>
                          </a>

                          <form action="{{ route('song.destroy', $song) }}" method="post" class="float-left">
                              @csrf
                              @method('DELETE')
