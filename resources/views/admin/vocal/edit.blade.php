    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Изменить вокальную партию</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form method="post" action="{{ route('vocal.update', $vocal)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="vocal" class="custom-file-input"
                                                id="exampleInputFile" value='{{$vocal->getAudio()}}'>
                                ...
                                @if ($vocal->getAudio())
                                <audio controls="controls" src="{{$vocal->getAudio()}}"></audio>
                                @else
                                <p>no audio</p>
                                @endif
                            </div>
