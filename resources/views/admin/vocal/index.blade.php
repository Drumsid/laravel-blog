    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
          <a class="btn btn-primary float-right" href="{{ route('vocal.create') }}" role="button">Добавить партию</a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                ...
                <table id="vocal-table" class="table table-bordered table-hover">
                  ...
                  @forelse ($vocals as $key => $vocal)
                    <tr>
                      ...
                      <td>
                          <a href="{{ route('vocal.edit', $vocal) }}" class="btn btn-info btn-sm float-left mr-1">
                              <i class="fas fa-pencil-alt"></i>
                          </a>

                          <form action="{{ route('vocal.destroy', $vocal) }}" method="post" class="float-left">
                              @csrf
                              @method('DELETE')
